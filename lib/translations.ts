			...
			jobs: [
					...
					roles: [
						{
							...
							description: [
								...
								"Overseeing registration, inquiry management, logistics distribution, and academic document flow.",
								"Coordinating with Chairs and Co-Chairs to maintain alignment across content, schedules, and delegation needs.",
								"Maintaining reliable remote presence during conferences to ensure a seamless delegate experience.",
							],
							highlights: [
								"Project Management",
								"Team Leadership",
				...
				},
				{
					...
					description: [
						...
						"Developing and managing MUSCLE's AI Driven Development pipeline.",
			...
			jobs: [
					...
					roles: [
						{
							...
							description: [
								...
								"Supervisando el registro, la gestión de consultas, la distribución logística y el flujo de documentos académicos.",
								"Coordinando con Chairs y Co-Chairs para mantener alineación en contenidos, horarios y necesidades delegacionales.",
								"Manteniendo presencia operativa remota durante las conferencias para asegurar una experiencia fluida.",
							],
							highlights: [
				...
				},
				{
					...
					description: [
						...
						"Desarrollando y gestionando el pipeline de desarrollo impulsado por IA de MUSCLE.",
