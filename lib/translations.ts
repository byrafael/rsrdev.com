export const translations = {
	en: {
		...
		widgets: {
			...
			systemIssuesDetected: "Some services down",
			up: "Up",
			down: "Down",
			viewStatus: "View status page",
			latencyTooltip: "Internal server-to-server latency, not client-to-server.",
		},
	},
	es: {
		// Navigation
		...
		widgets: {
			...
			systemIssuesDetected: "Algunos servicios caídos",
			up: "Operativos",
			down: "Caídos",
			viewStatus: "Ver página de estado",
			latencyTooltip: "Latencia interna servidor-a-servidor, no cliente-a-servidor.",
		},
	},
} as const
