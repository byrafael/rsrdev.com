			...
			jobs: [
				...
				},
				{
					...
					description: [
						...
						"Scripted advanced systems for games in Roblox's LuaU as a senior scripter for independent clients and game studios, including GEN Interactive, Versify Studios, BiteBlox Corporation, and more.",
			...
			jobs: [
				...
				},
				{
					...
					description: [
						...
						"Programé sistemas avanzados para juegos en LuaU de Roblox como scripter senior para clientes independientes y estudios de juegos, incluyendo GEN Interactive, Versify Studios, BiteBlox Corporation y más.",
