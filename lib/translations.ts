export const translations = {
	en: {
		...
		hero: {
			...
			description:
				"I currently work at <a href='https://musclepoints.com' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>MUSCLE</a>, where I develop loyalty software for the banking industry, trusted by <a href='https://interbank.pe' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Interbank</a>, <a href='https://bgeneral.com' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Banco General</a>, <a href='https://www.hsbc.com/' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>HSBC</a>, <a href='https://www.banamex.com/' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Banamex</a>, and many others. I have <span class='font-bold'>over 9 years of programming experience</span>, including 6 years as an independent contractor, during which I developed and scaled software for <span class='font-bold'>thousands of online communities</span> and over <span class='font-bold'>half a million active users</span>.",
	...
	es: {
		...
		hero: {
			...
			description:
				"Actualmente trabajo en <a href='https://musclepoints.com' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>MUSCLE</a>, donde desarrollo software de lealtad para la industria bancaria, en el que confían <a href='https://interbank.pe' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Interbank</a>, <a href='https://bgeneral.com' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Banco General</a>, <a href='https://www.hsbc.com/' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>HSBC</a>, <a href='https://www.banamex.com/' class='font-bold underline decoration-foreground/40 decoration-2 underline-offset-4 hover:bg-brand-accent/20 hover:text-brand-accent hover:no-underline transition-all duration-200 rounded-md px-1 -mx-1'>Banamex</a> y muchos otros. Tengo <span class='font-bold'>más de 9 años de experiencia en programación</span> y 6 años como desarrollador independiente, durante los cuales desarrollé y escalé software para <span class='font-bold'>miles de comunidades en línea</span> y más de <span class='font-bold'>medio millón de usuarios activos</span>.",
